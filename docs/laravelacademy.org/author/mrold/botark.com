...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
        <title>用户: mrold - Laravel学院</title>
...
<div id="page" class="hfeed site">
        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
            <ul class="nav navbar-nav">
                <li id="menu-item-7" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children menu-item-7 dropdown">
                    <a title="文档" href="botark.com#" data-toggle="dropdown" class="dropdown-toggle">文档 <span class="caret"></span></a>
                ...
                <li id="menu-item-3168" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children menu-item-3168 dropdown">
                    <a title="教程" href="botark.com#" data-toggle="dropdown" class="dropdown-toggle">教程 <span class="caret"></span></a>
                    <ul role="menu" class=" dropdown-menu">
                ...
                <li id="menu-item-671" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children menu-item-671 dropdown">
                    <a title="项目" href="botark.com#" data-toggle="dropdown" class="dropdown-toggle">项目 <span class="caret"></span></a>
                    <ul role="menu" class=" dropdown-menu">
                ...
                <li id="menu-item-159" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children menu-item-159 dropdown">
                    <a title="资源" href="botark.com#" data-toggle="dropdown" class="dropdown-toggle">资源 <span class="caret"></span></a>
                    <ul role="menu" class=" dropdown-menu">
                ...
                <li id="menu-item-4225" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-has-children menu-item-4225 dropdown">
                    <a title="现代PHP" href="botark.com#" data-toggle="dropdown" class="dropdown-toggle">现代PHP <span class="caret"></span></a>
                    <ul role="menu" class=" dropdown-menu">
    ...
    <li typeof="v:Breadcrumb">
        <a rel="v:url" property="v:title" href="../../index.html">首页</a>
            ...
            <span property="v:title">mrold</span>
        </li>
            </ol>    
    ...
    <h1 class="page-title">
        Author: <span class="vcard">mrold</span>
    </h1>
</header>

<div class="well author-meta">
    <div class="author-avatar text-center pull-left">
        <a href="../mrold"><img alt="mrold" src="https://avatars3.githubusercontent.com/u/9475864?v=4" class="avatar avatar-96 photo" height="96" width="96"></a>
    </div>
    <h4 class="author-meta-title">
        mrold has written <a href="../mrold">0</a> articles
    </h4>
    <div class="author-meta-bio">
        <p>@Bot_Ark</p>
        <p>
            <span class="point">积分：107</span>
            <span class="level">
                等级：P3
    ...
    <div class="author-meta-buttons text-right">
        <div class="btn-group">
            <a href="botark.com" class="btn btn-info bstooltip" title="" data-original-title="Website"><span class="glyphicon ipt-icon-home"></span></a>
        </div>
    </div>
...
<div class="author-catalog">
    <ul class="nav nav-pills">
        <li role="presentation" class=""><a href="article">发布的主题</a></li>
        <li role="presentation" class=""><a href="../../discussion/author/mrold">提问</a></li>
        <li role="presentation" class=""><a href="../../comment/author/mrold">评论/回复</a></li>
        <li role="presentation" class=""><a href="vote">喜欢的主题</a></li>
    </ul>
</div>            
